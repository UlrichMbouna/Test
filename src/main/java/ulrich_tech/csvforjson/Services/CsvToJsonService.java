...
/**
 * Lit un fichier CSV à partir d'un InputStream et retourne les données sous forme de liste de tableaux de chaînes.
 * 
 * @param inputStream Le flux d'entrée contenant les données CSV.
 * @return Une liste de tableaux de chaînes représentant les lignes du fichier CSV.
 * @throws IOException Si une erreur d'entrée/sortie se produit lors de la lecture du fichier.
 * @throws CsvException Si une erreur se produit lors de la lecture du CSV.
 */
